...
public class MultiGroupBy extends SubAssembly {
  ...
  public static class MultiBufferContext {
    ...
    HadoopSpillableTupleList _results =
        new HadoopSpillableTupleList(10000, (CompressionCodec) null, null);
    int _pipeFieldsSum;
  ...
  public MultiGroupBy(Pipe p0, Pipe p1, Fields groupFields, int pipeFieldsSum,
  ...
  public MultiGroupBy(Pipe p0, Fields group0, Pipe p1, Fields group1, int pipeFieldsSum,
      Fields groupRename, MultiBuffer operation) {
    Pipe[] pipes = new Pipe[]{p0, p1};
  ...
  public MultiGroupBy(Pipe[] pipes, Fields[] groupFields, int pipeFieldsSum, Fields groupingRename,
      MultiBuffer operation) {
